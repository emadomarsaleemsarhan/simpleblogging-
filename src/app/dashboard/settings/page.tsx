    ...
    <section>
      ...
      <BlogSettingsForm
        ...
        labels={{
          ...
          templatesSection: translator.t("settings.templatesSection"),
          ...
          themePrimaryColor: translator.t("settings.themePrimaryColor"),
          themeSecondaryColor: translator.t("settings.themeSecondaryColor"),
          themeBackgroundColor: translator.t("settings.themeBackgroundColor"),
          headingStyle: translator.t("settings.headingStyle"),
          headingClassic: translator.t("settings.headingClassic"),
          headingModern: translator.t("settings.headingModern"),
          headingBold: translator.t("settings.headingBold"),
          previewSavedTemplate: translator.t("settings.previewSavedTemplate"),
